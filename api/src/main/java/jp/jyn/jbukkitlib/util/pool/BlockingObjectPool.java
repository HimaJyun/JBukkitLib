...
public class BlockingObjectPool<E> implements ObjectPool<E> {
    private final BlockingQueue<E> queue;
    private final UnaryOperator<E> initializer;

    public BlockingObjectPool(int max, Supplier<E> supplier, UnaryOperator<E> initializer) {
    ...
    public BlockingObjectPool(int max, Supplier<E> supplier) {
